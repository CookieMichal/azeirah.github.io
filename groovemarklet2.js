...
function() {
    ...
    var a, d, c = !1,
        e = function() {
            var a = $("#now-playing-metadata").text(),
                b = "Grooveshark - " + a;
            return {
                song: a,
                title: b
            ...
            var a = $(".info .playerBarSong").text() + " - " + $(".info .playerBarArtist").text(),
                b = "Pandora - " + a;
            return {
                song: a,
                title: b
            ...
            var a = $("#now-playing-bar .bar-value").text(),
                b = "Plug.dj - " + a;
            return {
                song: a,
                title: b
            ...
            var a = $("#zp_current_song .ontheair_artist").text() + $("#zp_current_song .ontheair_song").text(),
                b = "Zaycev - " + a;
            return {
                song: a,
                title: b
            ...
            var a = $("#now_playing .title_artist .t").text() + " - " + $("#now_playing .title_artist .a").text(),
                b = "8tracks - " + a;
            return "" === $("#now_playing .title_artist .t").text() ? !1 : {
                song: a,
                title: b
            }
        }, j = function() {
            var a = $("#playerSongTitle").text() + " - " + $("#playerSongTitle").next().text().split("-")[0],
                b = a + " - My Library - Google Play";
            return a.length < 4 ? !1 : {
                song: a,
                title: b
            }
        }, k = function() {
            var a = $(".song_title").text() + " - " + $(".text_metadata .artist_title").text(),
                b = "Rdio - " + a;
            return {
                song: a,
                title: b
            ...
            var a = $('.playbackSoundBadge__title').text(),
                b = "Soundcloud - " + a;
            return {
                song: a,
                title: b
            ...
            var a = $(".GEKKVSQBL- a")[0].text + " - " + $(".GEKKVSQBL- a")[1].text + " - " + $(".GEKKVSQBL- a")[2].text,
                b = "Music Unlimited - " + a;
            return {
                song: a,
                title: b
            ...
            var song = $("span.currentSong").text();
            var title = "Dubtrack.fm - " + song;
            return {
              song: songs,
              title : title
            };
            ...
            youtify: m,
            "play.google": j,
            "music.sonyentertainmentnetwork": n,
            "dubtrack" : dubtrack
        }, p = function() {
            var a = d();
            q(a)
        }, q = function(a) {
            a ? ($("title").text(a.title), $(".SMGCurrentPlayingSong").text(a.song)) : $(".SMGCurrentPlayingSong").text("No song playing")
        }, r = function() {
            c && (p(), a = setInterval(p, 2e3))
        }, s = function() {
            a && (clearInterval(a), q())
        }, t = function() {
            ...
            document.getElementsByClassName("SMGContainer").length < 1 && (yepnope({
                ...
                key("ctrl+m", function() {
                    $(".SMGContainer").fadeToggle()
                })
            }))
        }, z = function() {
            $(".SMGContainer").hide().fadeIn(200), w(), $(".SMGStart").click(function() {
                "Start" === $(this).text() ? ($(".SMGRunning").text("Running."), $(this).text("Stop"), r()) : "Stop" === $(this).text() && ($(".SMGRunning").text("Not running."), $(this).text("Start"), s())
            }), r()
        };
    y()
}();
